          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" v-for="spuSaleAttrValue in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id" :class="{active:spuSaleAttrValue.isChecked == 1}" @click="changeActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)">{{ spuSaleAttrValue.saleAttrValueName }}</dd>     
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
    ...
    methods:{
      ...
      async addShopCart(){
        ...
        try {
          ...
          //在进行路由跳转的时候还需要传递一些参数
          //简单的参数用query传（复杂参数比如对象用query参数传一样可以实现，但是网址很长很难看），复杂的参数通过本地存储传
